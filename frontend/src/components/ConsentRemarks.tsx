  ...
  <Card className="mb-5">
    <CardContent className="p-5">
      <div className="grid grid-cols-2 gap-5">
        <div>
          <label className="text-sm text-[var(--text-muted)] block mb-2 font-semibold">Consent</label>
        ...
        <div>
          <label className="text-sm text-[var(--text-muted)] block mb-2 font-semibold">Remarks</label>
          <Textarea className="min-h-[80px] text-sm resize-y font-mono"
