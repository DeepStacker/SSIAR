...
# Default ROIs in template points
ROIS_P1_POINTS = {
...
def extract_dynamic_roi(aligned_img: np.ndarray, field_name: str, page_num: int) -> Optional[np.ndarray]:
    """
    ...
    # 3. Apply 20% padding and orientation correction
    return get_padded_roi_crop(aligned_img, refined, padding_pct=0.20)
